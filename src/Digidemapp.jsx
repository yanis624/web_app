      ...
      <section style={{ padding: "80px 32px", maxWidth: 960, margin: "0 auto" }}>
        <FadeIn>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <h2 style={{ fontFamily: FONT.serif, fontWeight: 700, fontSize: "clamp(22px, 3.5vw, 34px)", color: C.navy, margin: "20px 0 0" }}>{isEn ? "Seven partners, five countries, one shared goal" : "Sept partenaires, six pays, un objectif commun"}</h2>
            <Ornament width={50} style={{ marginTop: 20 }} />
          </div>
        </FadeIn>
