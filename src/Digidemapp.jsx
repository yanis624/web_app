...
function VeridemLogo({ height = 32, color = "#1e91a6" }) {
  return (
    <svg viewBox="0 0 2000 721.71" height={height} xmlns="http://www.w3.org/2000/svg">
      <g fill={color}>
        <path d="M1194.75,485.63c3.33-5.94,5-13.12,5-21.52s-1.67-15.77-5-21.64c-3.33-5.86-7.97-10.3-13.91-13.32-5.94-3.01-12.88-4.52-20.81-4.52h-23.54v78.95h23.54c7.93,0,14.86-1.5,20.81-4.52,5.94-3.01,10.58-7.49,13.91-13.44Z"/>
        <path d="M818.68,457.92c3.72-3.49,5.59-8.24,5.59-14.27s-1.86-10.78-5.59-14.27c-3.73-3.49-9.47-5.23-17.24-5.23h-20.45v39h20.45c7.77,0,13.51-1.74,17.24-5.23Z"/>
        <polygon points="796.28 505.48 780.99 505.48 780.99 545.83 823.49 545.83 796.28 505.48"/>
        <path d="M125.03,63.64v482.19h213.03l-69.75-164.95h60.4l39.61,97.14,40.76-97.14h55.17l-69.75,164.95h122.78v-164.95h135.3v42.33h-80.14v19.5h70.39v40.43h-70.39v21.88h83.23v40.82h69.2v-164.95h77.76c25.52,0,44.94,5.63,58.26,16.88,13.32,11.26,19.97,26.56,19.97,45.9,0,12.84-3.09,23.9-9.27,33.17-5.4,8.1-12.77,14.54-22.09,19.31l33.91,49.7h66.18v-164.95h56.12v164.95h74.67v-164.95h82.04c18.55,0,34.87,3.37,48.99,10.11,14.11,6.74,25.12,16.29,33.05,28.65,7.93,12.37,11.89,27.19,11.89,44.47s-3.96,31.91-11.89,44.35c-7.93,12.45-18.95,22.04-33.05,28.77-8.69,4.15-18.22,7.01-28.59,8.6h141.54v-164.95h135.3v42.33h-80.14v19.5h70.39v40.43h-70.39v21.88h83.23v40.82h69.2v-164.95h46.13l54.28,88.59,52.73-88.59h46.13l.47,164.95h143.28V63.64H125.03Z"/>
        <polygon points="1680.16 471.41 1643.95 532.35 1619.22 532.35 1583.07 474.04 1583.07 545.83 1680.56 545.83 1680.16 471.41"/>
      </g>
      <g fill={color}>
        <path d="M716.86,657.64v-50.62h21.84c5.64,0,10.02,1.13,13.12,3.4,3.11,2.27,4.66,5.47,4.66,9.62,0,2.75-.64,5.06-1.92,6.94-1.28,1.88-3.01,3.3-5.21,4.27-2.19.96-4.59,1.45-7.19,1.45l1.23-1.74c3.23,0,6.01.5,8.35,1.48,2.34.99,4.16,2.46,5.46,4.41,1.3,1.95,1.95,4.38,1.95,7.27,0,4.29-1.58,7.62-4.74,9.98-3.16,2.36-7.92,3.54-14.28,3.54h-23.28Z"/>
        <path d="M794.67,657.64v-18.8l1.23,3.33-21.48-35.14h5.71l18.87,30.88h-3.04l18.87-30.88h5.35l-21.48,35.14,1.23-3.33v18.8h-5.28Z"/>
        <path d="M876.38,657.64v-50.62h20.61c5.4,0,10.13,1.07,14.21,3.22,4.07,2.15,7.24,5.12,9.51,8.93,2.27,3.81,3.4,8.2,3.4,13.16s-1.13,9.35-3.4,13.16c-2.27,3.81-5.44,6.79-9.51,8.93-4.07,2.15-8.81,3.22-14.21,3.22h-20.61Z"/>
        <path d="M950.58,657.64v-50.62h5.35v50.62h-5.35Z"/>
        <path d="M1009.08,658.07c-3.86,0-7.41-.64-10.67-1.92-3.25-1.28-6.07-3.07-8.46-5.39s-4.24-5.04-5.57-8.17c-1.33-3.13-1.99-6.56-1.99-10.27s.66-7.13,1.99-10.27c1.33-3.13,3.19-5.86,5.6-8.17,2.41-2.31,5.24-4.11,8.5-5.39s6.81-1.92,10.66-1.92,7.39.6,10.59,1.81c3.21,1.21,5.94,3.04,8.21,5.5l-3.33,3.4c-2.12-2.12-4.46-3.64-7.01-4.56-2.56-.91-5.3-1.37-8.24-1.37-3.13,0-6.01.52-8.64,1.55-2.63,1.04-4.92,2.51-6.87,4.41-1.95,1.91-3.47,4.12-4.56,6.65-1.08,2.53-1.63,5.31-1.63,8.35s.54,5.76,1.63,8.32c1.08,2.56,2.6,4.79,4.56,6.69,1.95,1.91,4.24,3.38,6.87,4.41,2.63,1.04,5.48,1.55,8.57,1.55,2.89,0,5.63-.43,8.21-1.3,2.58-.87,4.95-2.34,7.12-4.41l3.04,4.05c-2.41,2.12-5.23,3.72-8.46,4.81-3.23,1.09-6.6,1.63-10.12,1.63Z"/>
        <path d="M1057.23,657.64v-50.62h5.35v50.62h-5.35Z"/>
        <path d="M1093.53,657.64v-50.62h20.61c5.4,0,10.14,1.07,14.21,3.22,4.07,2.15,7.24,5.12,9.51,8.93,2.27,3.81,3.4,8.2,3.4,13.16s-1.13,9.35-3.4,13.16c-2.27,3.81-5.44,6.79-9.51,8.93-4.07,2.15-8.81,3.22-14.21,3.22h-20.61Z"/>
        <path d="M1167.73,657.64v-50.62h34.71v4.63h-29.36v41.36h30.44v4.63h-35.79Z"/>
        <path d="M1230.57,657.64v-50.62h4.41l23.14,39.48h-2.31l22.92-39.48h4.41v50.62h-5.13v-42.59h1.23l-21.12,36.16h-2.53l-21.26-36.16h1.37v42.59h-5.13Z"/>
      </g>
    </svg>
  );
}
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          <FadeIn>
            ...
            <p style={{ fontFamily: FONT.sans, fontSize: 16, color: C.textLight, lineHeight: 1.85, maxWidth: 620, margin: "0 auto" }}>
              DIGIDEM est un projet européen Erasmus+ réunissant sept partenaires de six pays autour d'un objectif commun : développer un programme de formation innovant visant à renforcer les compétences numériques et l'engagement civique. Notre approche allie analyse computationnelle d'images, détection par IA, et ateliers pratiques lors du Marathon du Web.
            </p>
          </FadeIn>
